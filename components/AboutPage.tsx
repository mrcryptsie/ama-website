...
const TeamMemberCard: React.FC<{ member: TeamMember }> = ({ member }) => (
  <div className="bg-white rounded-lg shadow-xl overflow-hidden text-center transform hover:-translate-y-2 transition-transform duration-300 flex flex-col">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-4 text-lg">
                Face au double défi du déficit de profils techniques en Afrique et de l'inadéquation entre la formation universitaire et le marché de l'emploi, l'AMA apporte une réponse concrète.
              </p>
              <p className="text-gray-700 font-semibold text-ama-blue bg-orange-50 border-l-4 border-ama-orange p-4 rounded-r-lg text-lg">
                Notre mission est de former des experts capables de répondre efficacement aux exigences du monde professionnel, en leur offrant des programmes innovants et alignés sur les standards internationaux.
              </p>
            </div>
            <div>
           ...
           <div className="mt-20 text-center bg-ama-blue text-white p-10 rounded-lg shadow-2xl">
              <h2 className="text-3xl font-bold mb-4">Notre Vision à l'Horizon 2030</h2>
              <p className="text-xl max-w-4xl mx-auto text-gray-200">
                Bâtir l'écosystème de référence en Afrique pour le développement et la valorisation des talents scientifiques, avec pour ambition de certifier plus de 1 000 jeunes et de faciliter leur insertion durable dans le marché de l'emploi.
              </p>
           </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-ama-gray">
          <div className="container mx-auto px-6">
              ...
              <div className="max-w-3xl mx-auto">
                  <div className="relative border-l-2 border-ama-orange pl-8 space-y-12">
       ...
       <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <p className="text-center max-w-3xl mx-auto text-gray-600 mb-12">
            La qualité de notre programme dépend directement de celle de nos formateurs. Nous sommes fiers de rassembler des profils hautement spécialisés pour offrir le meilleur accompagnement possible.
          </p>
       ...
       <section className="py-20 bg-ama-gray">
        <div className="container mx-auto px-6">
          ...
          <p className="text-center max-w-3xl mx-auto text-gray-600 mb-12">
            Composée d'experts et d'étudiants avancés, cette équipe constitue un relais essentiel entre les apprenants et la coordination académique, garantissant un suivi efficace et continu.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {mentors.map((mentor) => (
              <div key={mentor.name} className="bg-white p-6 rounded-lg shadow-lg flex items-center space-x-4 transform hover:scale-105 transition-transform">
